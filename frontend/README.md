...
5. ✅ **Gallery** — paginated image library: search, tag/model/album/favorites
   ...
   bulk select → ZIP download / delete, AI-tag batch, and a full **image editor**
   (sharpen, denoise, remove-bg, enhance-face, upscale, harmonize, and
   mask-based **inpaint** with a brush canvas → save in place or as a copy).
